...
/**
 * ¬еб сервис дл€ получени€ ежедневных данных ver 02.02.2016
 * 
 ...
 * 
 */
@WebServiceClient(name = "DailyInfo", targetNamespace = "http://web.cbr.ru/", wsdlLocation = "file:/D:/Proj/webapp2/customDailyInfo.asmx.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/Proj/webapp2/customDailyInfo.asmx.xml");
